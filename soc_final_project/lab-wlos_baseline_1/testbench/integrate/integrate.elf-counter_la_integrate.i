# 0 "counter_la_integrate.c"
# 1 "/home/ubuntu/Desktop/lab-wlos_baseline_1/testbench/integrate//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_integrate.c"
# 19 "counter_la_integrate.c"
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
...
# 21 "counter_la_integrate.c" 2

# 1 "../../firmware/user_uart.h" 1
# 23 "counter_la_integrate.c" 2
...
# 25 "counter_la_integrate.c" 2
# 39 "counter_la_integrate.c"
...
# 208 "counter_la_integrate.c"
 ...
 (*(volatile uint32_t *)0x36000000)=0x01;
 ...
 for (int i = 0; i < 64; i++)
 {
  ...
  (*(volatile uint32_t *)0x36000080) = x;
 }


 uint32_t y;
 y = (*(volatile uint32_t *)0x36000084);
 if (y == 0x2A2D) {
  (*(volatile uint32_t*)0x2600000c) = (y<<24) | 0x00A60000;
 }
